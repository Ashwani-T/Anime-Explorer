...
//fun CachedAnimeItem.toAnimeUiModel(): AnimeUiModel {
//    return AnimeUiModel(
//        id = malId,
//        title = title,
...
interface AnimeDetailsDao{
    ...
    suspend fun getAnimeList(): List<AnimeDetailsEntity>

    @Query("SELECT * FROM anime_details WHERE title LIKE '%'||:query ||'%'")
    suspend fun getSearchedAnimeList(query: String): List<AnimeDetailsEntity>
}
